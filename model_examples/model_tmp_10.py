...
class L281(tf.keras.layers.Layer):
	...
	def build(self, input_shape):
		...
		regularizer = tf.keras.regularizers.L1(l1=0.004)
		constrain = tf.keras.constraints.MinMaxNorm(min_value=1.184, max_value=1.184, rate=1.0, axis=0)
...
class L2(tf.keras.layers.Layer):
	def __init__(self):
...
layer_284 = L284()
layer_284_out = layer_284(layer_1_out)

layer_285 = L285()
try:
	try:
		layer_285_concat = tf.keras.layers.concatenate([layer_1_out, layer_284_out])
		layer_285_out = layer_285(layer_285_concat)
	except ValueError:
		layer_285_concat = tf.keras.layers.concatenate([layer_1_out, layer_284_out], axis=-2)
		layer_285_out = layer_285(layer_285_concat)
except ValueError:
	#print('do strong concat!')
	strong_concat_285 = Strong_concat()
	new_list_of_inputs = []
	for i in [layer_1_out, layer_284_out]:
		if type(i) == tuple:
			for i_2 in i:
...
try:
	try:
		layer_282_concat = tf.keras.layers.concatenate([layer_1_out, layer_284_out, layer_285_out])
		layer_282_out = layer_282(layer_282_concat)
	except ValueError:
		layer_282_concat = tf.keras.layers.concatenate([layer_1_out, layer_284_out, layer_285_out], axis=-2)
		layer_282_out = layer_282(layer_282_concat)
except ValueError:
	#print('do strong concat!')
	strong_concat_282 = Strong_concat()
	new_list_of_inputs = []
	for i in [layer_1_out, layer_284_out, layer_285_out]:
		if type(i) == tuple:
			for i_2 in i:
				new_list_of_inputs.append(i_2)
		else:
...
try:
	try:
		layer_283_concat = tf.keras.layers.concatenate([layer_1_out, layer_284_out, layer_285_out])
		layer_283_out = layer_283(layer_283_concat)
	except ValueError:
		layer_283_concat = tf.keras.layers.concatenate([layer_1_out, layer_284_out, layer_285_out], axis=-2)
		layer_283_out = layer_283(layer_283_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_281_concat = tf.keras.layers.concatenate([layer_1_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_281_out = layer_281(layer_281_concat)
	except ValueError:
		layer_281_concat = tf.keras.layers.concatenate([layer_1_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_281_out = layer_281(layer_281_concat)
except ValueError:
	#print('do strong concat!')
	strong_concat_281 = Strong_concat()
	new_list_of_inputs = []
	for i in [layer_1_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out]:
		if type(i) == tuple:
			for i_2 in i:
				new_list_of_inputs.append(i_2)
		else:
...
try:
	try:
		layer_0_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_0_out = layer_0(layer_0_concat)
	except ValueError:
		layer_0_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_0_out = layer_0(layer_0_concat)
except ValueError:
	#print('do strong concat!')
	strong_concat_0 = Strong_concat()
	new_list_of_inputs = []
	for i in [layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out]:
		if type(i) == tuple:
			for i_2 in i:
				new_list_of_inputs.append(i_2)
		else:
...
try:
	try:
		layer_2_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_2_out = layer_2(layer_2_concat)
	except ValueError:
		layer_2_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_2_out = layer_2(layer_2_concat)
except ValueError:
	#print('do strong concat!')
	strong_concat_2 = Strong_concat()
	new_list_of_inputs = []
	for i in [layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out]:
		if type(i) == tuple:
			for i_2 in i:
	...
	layer_2_concat = strong_concat_2(new_list_of_inputs)
	layer_2_out = layer_2(layer_2_concat)
if layer_2.count_params() != 0:
	if 2 in set_weigths:
		if len(layer_2.get_weights()) > 1:
			new_w = [get_new_weigths(layer_2, set_weigths[2])]+layer_2.get_weights()[1:]
		else:
			new_w = [get_new_weigths(layer_2, set_weigths[2])]
		layer_2.set_weights(new_w)


try:
	count = 1
	for s in layer_2_out.shape:
		count = count*s
		if count > 10000000:
			raise NameError
	#print('do #2:',count)
except AttributeError:
	for i in layer_2_out:
		count = 1
		for s in layer_2_out.shape:
			count = count*s
			if count > 10000000:
...
try:
	try:
		layer_3_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_3_out = layer_3(layer_3_concat)
	except ValueError:
		layer_3_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_3_out = layer_3(layer_3_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_6_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_6_out = layer_6(layer_6_concat)
	except ValueError:
		layer_6_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_6_out = layer_6(layer_6_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_7_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_7_out = layer_7(layer_7_concat)
	except ValueError:
		layer_7_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_7_out = layer_7(layer_7_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_8_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_8_out = layer_8(layer_8_concat)
	except ValueError:
		layer_8_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_8_out = layer_8(layer_8_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_9_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_9_out = layer_9(layer_9_concat)
	except ValueError:
		layer_9_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_9_out = layer_9(layer_9_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_10_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_10_out = layer_10(layer_10_concat)
	except ValueError:
		layer_10_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_10_out = layer_10(layer_10_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_11_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_11_out = layer_11(layer_11_concat)
	except ValueError:
		layer_11_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_11_out = layer_11(layer_11_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_12_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_12_out = layer_12(layer_12_concat)
	except ValueError:
		layer_12_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_12_out = layer_12(layer_12_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_13_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_13_out = layer_13(layer_13_concat)
	except ValueError:
		layer_13_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_13_out = layer_13(layer_13_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_14_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_14_out = layer_14(layer_14_concat)
	except ValueError:
		layer_14_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_14_out = layer_14(layer_14_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_15_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_15_out = layer_15(layer_15_concat)
	except ValueError:
		layer_15_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_15_out = layer_15(layer_15_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_16_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_16_out = layer_16(layer_16_concat)
	except ValueError:
		layer_16_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_16_out = layer_16(layer_16_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_17_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_17_out = layer_17(layer_17_concat)
	except ValueError:
		layer_17_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_17_out = layer_17(layer_17_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_18_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_18_out = layer_18(layer_18_concat)
	except ValueError:
		layer_18_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_18_out = layer_18(layer_18_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_19_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_19_out = layer_19(layer_19_concat)
	except ValueError:
		layer_19_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_19_out = layer_19(layer_19_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_20_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_20_out = layer_20(layer_20_concat)
	except ValueError:
		layer_20_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_20_out = layer_20(layer_20_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_21_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_21_out = layer_21(layer_21_concat)
	except ValueError:
		layer_21_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_21_out = layer_21(layer_21_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_22_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_22_out = layer_22(layer_22_concat)
	except ValueError:
		layer_22_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_22_out = layer_22(layer_22_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_23_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_23_out = layer_23(layer_23_concat)
	except ValueError:
		layer_23_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_23_out = layer_23(layer_23_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_24_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_24_out = layer_24(layer_24_concat)
	except ValueError:
		layer_24_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_24_out = layer_24(layer_24_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_25_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_25_out = layer_25(layer_25_concat)
	except ValueError:
		layer_25_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_25_out = layer_25(layer_25_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_26_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_26_out = layer_26(layer_26_concat)
	except ValueError:
		layer_26_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_26_out = layer_26(layer_26_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_27_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_27_out = layer_27(layer_27_concat)
	except ValueError:
		layer_27_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_27_out = layer_27(layer_27_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_28_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_28_out = layer_28(layer_28_concat)
	except ValueError:
		layer_28_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_28_out = layer_28(layer_28_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_29_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_29_out = layer_29(layer_29_concat)
	except ValueError:
		layer_29_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_29_out = layer_29(layer_29_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_30_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_30_out = layer_30(layer_30_concat)
	except ValueError:
		layer_30_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_30_out = layer_30(layer_30_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_31_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_31_out = layer_31(layer_31_concat)
	except ValueError:
		layer_31_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_31_out = layer_31(layer_31_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_32_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_32_out = layer_32(layer_32_concat)
	except ValueError:
		layer_32_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_32_out = layer_32(layer_32_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_33_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_33_out = layer_33(layer_33_concat)
	except ValueError:
		layer_33_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_33_out = layer_33(layer_33_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_34_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_34_out = layer_34(layer_34_concat)
	except ValueError:
		layer_34_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_34_out = layer_34(layer_34_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_35_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_35_out = layer_35(layer_35_concat)
	except ValueError:
		layer_35_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_35_out = layer_35(layer_35_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_36_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_36_out = layer_36(layer_36_concat)
	except ValueError:
		layer_36_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_36_out = layer_36(layer_36_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_37_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_37_out = layer_37(layer_37_concat)
	except ValueError:
		layer_37_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_37_out = layer_37(layer_37_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_38_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_38_out = layer_38(layer_38_concat)
	except ValueError:
		layer_38_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_38_out = layer_38(layer_38_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_39_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_39_out = layer_39(layer_39_concat)
	except ValueError:
		layer_39_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_39_out = layer_39(layer_39_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_40_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_40_out = layer_40(layer_40_concat)
	except ValueError:
		layer_40_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_40_out = layer_40(layer_40_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_41_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_41_out = layer_41(layer_41_concat)
	except ValueError:
		layer_41_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_41_out = layer_41(layer_41_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_42_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_42_out = layer_42(layer_42_concat)
	except ValueError:
		layer_42_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_42_out = layer_42(layer_42_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_43_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_43_out = layer_43(layer_43_concat)
	except ValueError:
		layer_43_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_43_out = layer_43(layer_43_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_44_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_44_out = layer_44(layer_44_concat)
	except ValueError:
		layer_44_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_44_out = layer_44(layer_44_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_45_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_45_out = layer_45(layer_45_concat)
	except ValueError:
		layer_45_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_45_out = layer_45(layer_45_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_46_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_46_out = layer_46(layer_46_concat)
	except ValueError:
		layer_46_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_46_out = layer_46(layer_46_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_47_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_47_out = layer_47(layer_47_concat)
	except ValueError:
		layer_47_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_47_out = layer_47(layer_47_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_48_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_48_out = layer_48(layer_48_concat)
	except ValueError:
		layer_48_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_48_out = layer_48(layer_48_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_49_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_49_out = layer_49(layer_49_concat)
	except ValueError:
		layer_49_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_49_out = layer_49(layer_49_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_50_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_50_out = layer_50(layer_50_concat)
	except ValueError:
		layer_50_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_50_out = layer_50(layer_50_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_51_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_51_out = layer_51(layer_51_concat)
	except ValueError:
		layer_51_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_51_out = layer_51(layer_51_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_52_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_52_out = layer_52(layer_52_concat)
	except ValueError:
		layer_52_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_52_out = layer_52(layer_52_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_53_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_53_out = layer_53(layer_53_concat)
	except ValueError:
		layer_53_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_53_out = layer_53(layer_53_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_54_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_54_out = layer_54(layer_54_concat)
	except ValueError:
		layer_54_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_54_out = layer_54(layer_54_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_55_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_55_out = layer_55(layer_55_concat)
	except ValueError:
		layer_55_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_55_out = layer_55(layer_55_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_56_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_56_out = layer_56(layer_56_concat)
	except ValueError:
		layer_56_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_56_out = layer_56(layer_56_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_57_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_57_out = layer_57(layer_57_concat)
	except ValueError:
		layer_57_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_57_out = layer_57(layer_57_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_58_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_58_out = layer_58(layer_58_concat)
	except ValueError:
		layer_58_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_58_out = layer_58(layer_58_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_59_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_59_out = layer_59(layer_59_concat)
	except ValueError:
		layer_59_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_59_out = layer_59(layer_59_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_60_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_60_out = layer_60(layer_60_concat)
	except ValueError:
		layer_60_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_60_out = layer_60(layer_60_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_61_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_61_out = layer_61(layer_61_concat)
	except ValueError:
		layer_61_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_61_out = layer_61(layer_61_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_62_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_62_out = layer_62(layer_62_concat)
	except ValueError:
		layer_62_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_62_out = layer_62(layer_62_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_63_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_63_out = layer_63(layer_63_concat)
	except ValueError:
		layer_63_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_63_out = layer_63(layer_63_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_64_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_64_out = layer_64(layer_64_concat)
	except ValueError:
		layer_64_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_64_out = layer_64(layer_64_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_65_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_65_out = layer_65(layer_65_concat)
	except ValueError:
		layer_65_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_65_out = layer_65(layer_65_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_66_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_66_out = layer_66(layer_66_concat)
	except ValueError:
		layer_66_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_66_out = layer_66(layer_66_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_67_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_67_out = layer_67(layer_67_concat)
	except ValueError:
		layer_67_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_67_out = layer_67(layer_67_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_68_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_68_out = layer_68(layer_68_concat)
	except ValueError:
		layer_68_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_68_out = layer_68(layer_68_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_69_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_69_out = layer_69(layer_69_concat)
	except ValueError:
		layer_69_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_69_out = layer_69(layer_69_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_70_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_70_out = layer_70(layer_70_concat)
	except ValueError:
		layer_70_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_70_out = layer_70(layer_70_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_71_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_71_out = layer_71(layer_71_concat)
	except ValueError:
		layer_71_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_71_out = layer_71(layer_71_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_72_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_72_out = layer_72(layer_72_concat)
	except ValueError:
		layer_72_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_72_out = layer_72(layer_72_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_73_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_73_out = layer_73(layer_73_concat)
	except ValueError:
		layer_73_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_73_out = layer_73(layer_73_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_74_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_74_out = layer_74(layer_74_concat)
	except ValueError:
		layer_74_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_74_out = layer_74(layer_74_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_75_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_75_out = layer_75(layer_75_concat)
	except ValueError:
		layer_75_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_75_out = layer_75(layer_75_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_76_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_76_out = layer_76(layer_76_concat)
	except ValueError:
		layer_76_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_76_out = layer_76(layer_76_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_77_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_77_out = layer_77(layer_77_concat)
	except ValueError:
		layer_77_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_77_out = layer_77(layer_77_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_78_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_78_out = layer_78(layer_78_concat)
	except ValueError:
		layer_78_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_78_out = layer_78(layer_78_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_79_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_79_out = layer_79(layer_79_concat)
	except ValueError:
		layer_79_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_79_out = layer_79(layer_79_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_80_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_80_out = layer_80(layer_80_concat)
	except ValueError:
		layer_80_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_80_out = layer_80(layer_80_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_81_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_81_out = layer_81(layer_81_concat)
	except ValueError:
		layer_81_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_81_out = layer_81(layer_81_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_82_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_82_out = layer_82(layer_82_concat)
	except ValueError:
		layer_82_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_82_out = layer_82(layer_82_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_83_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_83_out = layer_83(layer_83_concat)
	except ValueError:
		layer_83_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_83_out = layer_83(layer_83_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_84_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_84_out = layer_84(layer_84_concat)
	except ValueError:
		layer_84_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_84_out = layer_84(layer_84_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_85_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_85_out = layer_85(layer_85_concat)
	except ValueError:
		layer_85_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_85_out = layer_85(layer_85_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_86_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_86_out = layer_86(layer_86_concat)
	except ValueError:
		layer_86_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_86_out = layer_86(layer_86_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_87_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_87_out = layer_87(layer_87_concat)
	except ValueError:
		layer_87_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_87_out = layer_87(layer_87_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_88_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_88_out = layer_88(layer_88_concat)
	except ValueError:
		layer_88_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_88_out = layer_88(layer_88_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_89_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_89_out = layer_89(layer_89_concat)
	except ValueError:
		layer_89_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_89_out = layer_89(layer_89_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_90_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_90_out = layer_90(layer_90_concat)
	except ValueError:
		layer_90_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_90_out = layer_90(layer_90_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_91_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_91_out = layer_91(layer_91_concat)
	except ValueError:
		layer_91_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_91_out = layer_91(layer_91_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_92_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_92_out = layer_92(layer_92_concat)
	except ValueError:
		layer_92_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_92_out = layer_92(layer_92_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_93_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_93_out = layer_93(layer_93_concat)
	except ValueError:
		layer_93_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_93_out = layer_93(layer_93_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_94_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_94_out = layer_94(layer_94_concat)
	except ValueError:
		layer_94_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_94_out = layer_94(layer_94_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_95_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_95_out = layer_95(layer_95_concat)
	except ValueError:
		layer_95_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_95_out = layer_95(layer_95_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_96_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_96_out = layer_96(layer_96_concat)
	except ValueError:
		layer_96_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_96_out = layer_96(layer_96_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_97_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_97_out = layer_97(layer_97_concat)
	except ValueError:
		layer_97_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_97_out = layer_97(layer_97_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_98_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_98_out = layer_98(layer_98_concat)
	except ValueError:
		layer_98_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_98_out = layer_98(layer_98_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_99_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_99_out = layer_99(layer_99_concat)
	except ValueError:
		layer_99_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_99_out = layer_99(layer_99_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_100_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_100_out = layer_100(layer_100_concat)
	except ValueError:
		layer_100_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_100_out = layer_100(layer_100_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_101_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_101_out = layer_101(layer_101_concat)
	except ValueError:
		layer_101_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_101_out = layer_101(layer_101_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_102_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_102_out = layer_102(layer_102_concat)
	except ValueError:
		layer_102_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_102_out = layer_102(layer_102_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_103_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_103_out = layer_103(layer_103_concat)
	except ValueError:
		layer_103_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_103_out = layer_103(layer_103_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_104_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_104_out = layer_104(layer_104_concat)
	except ValueError:
		layer_104_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_104_out = layer_104(layer_104_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_105_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_105_out = layer_105(layer_105_concat)
	except ValueError:
		layer_105_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_105_out = layer_105(layer_105_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_106_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_106_out = layer_106(layer_106_concat)
	except ValueError:
		layer_106_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_106_out = layer_106(layer_106_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_107_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_107_out = layer_107(layer_107_concat)
	except ValueError:
		layer_107_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_107_out = layer_107(layer_107_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_108_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_108_out = layer_108(layer_108_concat)
	except ValueError:
		layer_108_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_108_out = layer_108(layer_108_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_109_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_109_out = layer_109(layer_109_concat)
	except ValueError:
		layer_109_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_109_out = layer_109(layer_109_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_110_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_110_out = layer_110(layer_110_concat)
	except ValueError:
		layer_110_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_110_out = layer_110(layer_110_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_111_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_111_out = layer_111(layer_111_concat)
	except ValueError:
		layer_111_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_111_out = layer_111(layer_111_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_112_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_112_out = layer_112(layer_112_concat)
	except ValueError:
		layer_112_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_112_out = layer_112(layer_112_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_113_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_113_out = layer_113(layer_113_concat)
	except ValueError:
		layer_113_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_113_out = layer_113(layer_113_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_114_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_114_out = layer_114(layer_114_concat)
	except ValueError:
		layer_114_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_114_out = layer_114(layer_114_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_115_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_115_out = layer_115(layer_115_concat)
	except ValueError:
		layer_115_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_115_out = layer_115(layer_115_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_116_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_116_out = layer_116(layer_116_concat)
	except ValueError:
		layer_116_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_116_out = layer_116(layer_116_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_117_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_117_out = layer_117(layer_117_concat)
	except ValueError:
		layer_117_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_117_out = layer_117(layer_117_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_118_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_118_out = layer_118(layer_118_concat)
	except ValueError:
		layer_118_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_118_out = layer_118(layer_118_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_119_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_119_out = layer_119(layer_119_concat)
	except ValueError:
		layer_119_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_119_out = layer_119(layer_119_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_120_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_120_out = layer_120(layer_120_concat)
	except ValueError:
		layer_120_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_120_out = layer_120(layer_120_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_121_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_121_out = layer_121(layer_121_concat)
	except ValueError:
		layer_121_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_121_out = layer_121(layer_121_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_122_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_122_out = layer_122(layer_122_concat)
	except ValueError:
		layer_122_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_122_out = layer_122(layer_122_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_123_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_123_out = layer_123(layer_123_concat)
	except ValueError:
		layer_123_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_123_out = layer_123(layer_123_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_124_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_124_out = layer_124(layer_124_concat)
	except ValueError:
		layer_124_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_124_out = layer_124(layer_124_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_125_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_125_out = layer_125(layer_125_concat)
	except ValueError:
		layer_125_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_125_out = layer_125(layer_125_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_126_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_126_out = layer_126(layer_126_concat)
	except ValueError:
		layer_126_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_126_out = layer_126(layer_126_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_127_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_127_out = layer_127(layer_127_concat)
	except ValueError:
		layer_127_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_127_out = layer_127(layer_127_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_128_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_128_out = layer_128(layer_128_concat)
	except ValueError:
		layer_128_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_128_out = layer_128(layer_128_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_129_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_129_out = layer_129(layer_129_concat)
	except ValueError:
		layer_129_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_129_out = layer_129(layer_129_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_130_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_130_out = layer_130(layer_130_concat)
	except ValueError:
		layer_130_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_130_out = layer_130(layer_130_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_131_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_131_out = layer_131(layer_131_concat)
	except ValueError:
		layer_131_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_131_out = layer_131(layer_131_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_132_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_132_out = layer_132(layer_132_concat)
	except ValueError:
		layer_132_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_132_out = layer_132(layer_132_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_133_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_133_out = layer_133(layer_133_concat)
	except ValueError:
		layer_133_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_133_out = layer_133(layer_133_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_134_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_134_out = layer_134(layer_134_concat)
	except ValueError:
		layer_134_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_134_out = layer_134(layer_134_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_135_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_135_out = layer_135(layer_135_concat)
	except ValueError:
		layer_135_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_135_out = layer_135(layer_135_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_136_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_136_out = layer_136(layer_136_concat)
	except ValueError:
		layer_136_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_136_out = layer_136(layer_136_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_137_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_137_out = layer_137(layer_137_concat)
	except ValueError:
		layer_137_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_137_out = layer_137(layer_137_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_138_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_138_out = layer_138(layer_138_concat)
	except ValueError:
		layer_138_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_138_out = layer_138(layer_138_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_139_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_139_out = layer_139(layer_139_concat)
	except ValueError:
		layer_139_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_139_out = layer_139(layer_139_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_140_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_140_out = layer_140(layer_140_concat)
	except ValueError:
		layer_140_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_140_out = layer_140(layer_140_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_141_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_141_out = layer_141(layer_141_concat)
	except ValueError:
		layer_141_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_141_out = layer_141(layer_141_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_142_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_142_out = layer_142(layer_142_concat)
	except ValueError:
		layer_142_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_142_out = layer_142(layer_142_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_143_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_143_out = layer_143(layer_143_concat)
	except ValueError:
		layer_143_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_143_out = layer_143(layer_143_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_144_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_144_out = layer_144(layer_144_concat)
	except ValueError:
		layer_144_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_144_out = layer_144(layer_144_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_145_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_145_out = layer_145(layer_145_concat)
	except ValueError:
		layer_145_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_145_out = layer_145(layer_145_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_146_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_146_out = layer_146(layer_146_concat)
	except ValueError:
		layer_146_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_146_out = layer_146(layer_146_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_147_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_147_out = layer_147(layer_147_concat)
	except ValueError:
		layer_147_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_147_out = layer_147(layer_147_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_148_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_148_out = layer_148(layer_148_concat)
	except ValueError:
		layer_148_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_148_out = layer_148(layer_148_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_149_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_149_out = layer_149(layer_149_concat)
	except ValueError:
		layer_149_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_149_out = layer_149(layer_149_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_150_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_150_out = layer_150(layer_150_concat)
	except ValueError:
		layer_150_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_150_out = layer_150(layer_150_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_151_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_151_out = layer_151(layer_151_concat)
	except ValueError:
		layer_151_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_151_out = layer_151(layer_151_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_152_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_152_out = layer_152(layer_152_concat)
	except ValueError:
		layer_152_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_152_out = layer_152(layer_152_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_153_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_153_out = layer_153(layer_153_concat)
	except ValueError:
		layer_153_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_153_out = layer_153(layer_153_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_154_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_154_out = layer_154(layer_154_concat)
	except ValueError:
		layer_154_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_154_out = layer_154(layer_154_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_155_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_155_out = layer_155(layer_155_concat)
	except ValueError:
		layer_155_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_155_out = layer_155(layer_155_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_156_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_156_out = layer_156(layer_156_concat)
	except ValueError:
		layer_156_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_156_out = layer_156(layer_156_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_157_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_157_out = layer_157(layer_157_concat)
	except ValueError:
		layer_157_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_157_out = layer_157(layer_157_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_158_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_158_out = layer_158(layer_158_concat)
	except ValueError:
		layer_158_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_158_out = layer_158(layer_158_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_159_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_159_out = layer_159(layer_159_concat)
	except ValueError:
		layer_159_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_159_out = layer_159(layer_159_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_160_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_160_out = layer_160(layer_160_concat)
	except ValueError:
		layer_160_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_160_out = layer_160(layer_160_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_161_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_161_out = layer_161(layer_161_concat)
	except ValueError:
		layer_161_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_161_out = layer_161(layer_161_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_162_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_162_out = layer_162(layer_162_concat)
	except ValueError:
		layer_162_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_162_out = layer_162(layer_162_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_163_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_163_out = layer_163(layer_163_concat)
	except ValueError:
		layer_163_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_163_out = layer_163(layer_163_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_164_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_164_out = layer_164(layer_164_concat)
	except ValueError:
		layer_164_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_164_out = layer_164(layer_164_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_165_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_165_out = layer_165(layer_165_concat)
	except ValueError:
		layer_165_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_165_out = layer_165(layer_165_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_166_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_166_out = layer_166(layer_166_concat)
	except ValueError:
		layer_166_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_166_out = layer_166(layer_166_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_167_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_167_out = layer_167(layer_167_concat)
	except ValueError:
		layer_167_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_167_out = layer_167(layer_167_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_168_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_168_out = layer_168(layer_168_concat)
	except ValueError:
		layer_168_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_168_out = layer_168(layer_168_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_169_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_169_out = layer_169(layer_169_concat)
	except ValueError:
		layer_169_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_169_out = layer_169(layer_169_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_170_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_170_out = layer_170(layer_170_concat)
	except ValueError:
		layer_170_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_170_out = layer_170(layer_170_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_171_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_171_out = layer_171(layer_171_concat)
	except ValueError:
		layer_171_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_171_out = layer_171(layer_171_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_172_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_172_out = layer_172(layer_172_concat)
	except ValueError:
		layer_172_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_172_out = layer_172(layer_172_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_173_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_173_out = layer_173(layer_173_concat)
	except ValueError:
		layer_173_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_173_out = layer_173(layer_173_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_174_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_174_out = layer_174(layer_174_concat)
	except ValueError:
		layer_174_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_174_out = layer_174(layer_174_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_175_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_175_out = layer_175(layer_175_concat)
	except ValueError:
		layer_175_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_175_out = layer_175(layer_175_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_176_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_176_out = layer_176(layer_176_concat)
	except ValueError:
		layer_176_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_176_out = layer_176(layer_176_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_177_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_177_out = layer_177(layer_177_concat)
	except ValueError:
		layer_177_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_177_out = layer_177(layer_177_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_178_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_178_out = layer_178(layer_178_concat)
	except ValueError:
		layer_178_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_178_out = layer_178(layer_178_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_179_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_179_out = layer_179(layer_179_concat)
	except ValueError:
		layer_179_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_179_out = layer_179(layer_179_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_180_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_180_out = layer_180(layer_180_concat)
	except ValueError:
		layer_180_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_180_out = layer_180(layer_180_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_181_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_181_out = layer_181(layer_181_concat)
	except ValueError:
		layer_181_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_181_out = layer_181(layer_181_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_182_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_182_out = layer_182(layer_182_concat)
	except ValueError:
		layer_182_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_182_out = layer_182(layer_182_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_183_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_183_out = layer_183(layer_183_concat)
	except ValueError:
		layer_183_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_183_out = layer_183(layer_183_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_184_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_184_out = layer_184(layer_184_concat)
	except ValueError:
		layer_184_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_184_out = layer_184(layer_184_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_185_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_185_out = layer_185(layer_185_concat)
	except ValueError:
		layer_185_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_185_out = layer_185(layer_185_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_186_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_186_out = layer_186(layer_186_concat)
	except ValueError:
		layer_186_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_186_out = layer_186(layer_186_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_187_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_187_out = layer_187(layer_187_concat)
	except ValueError:
		layer_187_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_187_out = layer_187(layer_187_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_188_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_188_out = layer_188(layer_188_concat)
	except ValueError:
		layer_188_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_188_out = layer_188(layer_188_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_189_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_189_out = layer_189(layer_189_concat)
	except ValueError:
		layer_189_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_189_out = layer_189(layer_189_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_190_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_190_out = layer_190(layer_190_concat)
	except ValueError:
		layer_190_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_190_out = layer_190(layer_190_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_191_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_191_out = layer_191(layer_191_concat)
	except ValueError:
		layer_191_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_191_out = layer_191(layer_191_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_192_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_192_out = layer_192(layer_192_concat)
	except ValueError:
		layer_192_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_192_out = layer_192(layer_192_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_193_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_193_out = layer_193(layer_193_concat)
	except ValueError:
		layer_193_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_193_out = layer_193(layer_193_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_194_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_194_out = layer_194(layer_194_concat)
	except ValueError:
		layer_194_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_194_out = layer_194(layer_194_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_195_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_195_out = layer_195(layer_195_concat)
	except ValueError:
		layer_195_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_195_out = layer_195(layer_195_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_196_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_196_out = layer_196(layer_196_concat)
	except ValueError:
		layer_196_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_196_out = layer_196(layer_196_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_197_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_197_out = layer_197(layer_197_concat)
	except ValueError:
		layer_197_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_197_out = layer_197(layer_197_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_198_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_198_out = layer_198(layer_198_concat)
	except ValueError:
		layer_198_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_198_out = layer_198(layer_198_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_199_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_199_out = layer_199(layer_199_concat)
	except ValueError:
		layer_199_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_199_out = layer_199(layer_199_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_200_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_200_out = layer_200(layer_200_concat)
	except ValueError:
		layer_200_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_200_out = layer_200(layer_200_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_201_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_201_out = layer_201(layer_201_concat)
	except ValueError:
		layer_201_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_201_out = layer_201(layer_201_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_202_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_202_out = layer_202(layer_202_concat)
	except ValueError:
		layer_202_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_202_out = layer_202(layer_202_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_203_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_203_out = layer_203(layer_203_concat)
	except ValueError:
		layer_203_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_203_out = layer_203(layer_203_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_204_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_204_out = layer_204(layer_204_concat)
	except ValueError:
		layer_204_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_204_out = layer_204(layer_204_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_205_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_205_out = layer_205(layer_205_concat)
	except ValueError:
		layer_205_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_205_out = layer_205(layer_205_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_206_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_206_out = layer_206(layer_206_concat)
	except ValueError:
		layer_206_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_206_out = layer_206(layer_206_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_207_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_207_out = layer_207(layer_207_concat)
	except ValueError:
		layer_207_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_207_out = layer_207(layer_207_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_208_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_208_out = layer_208(layer_208_concat)
	except ValueError:
		layer_208_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_208_out = layer_208(layer_208_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_209_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_209_out = layer_209(layer_209_concat)
	except ValueError:
		layer_209_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_209_out = layer_209(layer_209_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_210_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_210_out = layer_210(layer_210_concat)
	except ValueError:
		layer_210_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_210_out = layer_210(layer_210_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_211_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_211_out = layer_211(layer_211_concat)
	except ValueError:
		layer_211_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_211_out = layer_211(layer_211_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_212_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_212_out = layer_212(layer_212_concat)
	except ValueError:
		layer_212_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_212_out = layer_212(layer_212_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_213_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_213_out = layer_213(layer_213_concat)
	except ValueError:
		layer_213_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_213_out = layer_213(layer_213_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_214_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_214_out = layer_214(layer_214_concat)
	except ValueError:
		layer_214_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_214_out = layer_214(layer_214_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_215_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_215_out = layer_215(layer_215_concat)
	except ValueError:
		layer_215_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_215_out = layer_215(layer_215_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_216_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_216_out = layer_216(layer_216_concat)
	except ValueError:
		layer_216_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_216_out = layer_216(layer_216_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_217_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_217_out = layer_217(layer_217_concat)
	except ValueError:
		layer_217_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_217_out = layer_217(layer_217_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_218_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_218_out = layer_218(layer_218_concat)
	except ValueError:
		layer_218_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_218_out = layer_218(layer_218_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_219_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_219_out = layer_219(layer_219_concat)
	except ValueError:
		layer_219_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_219_out = layer_219(layer_219_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_220_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_220_out = layer_220(layer_220_concat)
	except ValueError:
		layer_220_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_220_out = layer_220(layer_220_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_221_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_221_out = layer_221(layer_221_concat)
	except ValueError:
		layer_221_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_221_out = layer_221(layer_221_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_222_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_222_out = layer_222(layer_222_concat)
	except ValueError:
		layer_222_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_222_out = layer_222(layer_222_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_223_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_223_out = layer_223(layer_223_concat)
	except ValueError:
		layer_223_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_223_out = layer_223(layer_223_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_224_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_224_out = layer_224(layer_224_concat)
	except ValueError:
		layer_224_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_224_out = layer_224(layer_224_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_225_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_225_out = layer_225(layer_225_concat)
	except ValueError:
		layer_225_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_225_out = layer_225(layer_225_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_226_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_226_out = layer_226(layer_226_concat)
	except ValueError:
		layer_226_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_226_out = layer_226(layer_226_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_227_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_227_out = layer_227(layer_227_concat)
	except ValueError:
		layer_227_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_227_out = layer_227(layer_227_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_228_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_228_out = layer_228(layer_228_concat)
	except ValueError:
		layer_228_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_228_out = layer_228(layer_228_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_229_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_229_out = layer_229(layer_229_concat)
	except ValueError:
		layer_229_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_229_out = layer_229(layer_229_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_230_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_230_out = layer_230(layer_230_concat)
	except ValueError:
		layer_230_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_230_out = layer_230(layer_230_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_231_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_231_out = layer_231(layer_231_concat)
	except ValueError:
		layer_231_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_231_out = layer_231(layer_231_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_232_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_232_out = layer_232(layer_232_concat)
	except ValueError:
		layer_232_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_232_out = layer_232(layer_232_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_233_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_233_out = layer_233(layer_233_concat)
	except ValueError:
		layer_233_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_233_out = layer_233(layer_233_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_234_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_234_out = layer_234(layer_234_concat)
	except ValueError:
		layer_234_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_234_out = layer_234(layer_234_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_235_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_235_out = layer_235(layer_235_concat)
	except ValueError:
		layer_235_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_235_out = layer_235(layer_235_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_236_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_236_out = layer_236(layer_236_concat)
	except ValueError:
		layer_236_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_236_out = layer_236(layer_236_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_237_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_237_out = layer_237(layer_237_concat)
	except ValueError:
		layer_237_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_237_out = layer_237(layer_237_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_238_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_238_out = layer_238(layer_238_concat)
	except ValueError:
		layer_238_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_238_out = layer_238(layer_238_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_239_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_239_out = layer_239(layer_239_concat)
	except ValueError:
		layer_239_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_239_out = layer_239(layer_239_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_240_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_240_out = layer_240(layer_240_concat)
	except ValueError:
		layer_240_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_240_out = layer_240(layer_240_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_241_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_241_out = layer_241(layer_241_concat)
	except ValueError:
		layer_241_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_241_out = layer_241(layer_241_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_242_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_242_out = layer_242(layer_242_concat)
	except ValueError:
		layer_242_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_242_out = layer_242(layer_242_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_243_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_243_out = layer_243(layer_243_concat)
	except ValueError:
		layer_243_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_243_out = layer_243(layer_243_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_244_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_244_out = layer_244(layer_244_concat)
	except ValueError:
		layer_244_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_244_out = layer_244(layer_244_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_245_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_245_out = layer_245(layer_245_concat)
	except ValueError:
		layer_245_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_245_out = layer_245(layer_245_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_248_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_248_out = layer_248(layer_248_concat)
	except ValueError:
		layer_248_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_248_out = layer_248(layer_248_concat)
except ValueError:
	#print('do strong concat!')
	strong_concat_248 = Strong_concat()
	new_list_of_inputs = []
	for i in [layer_0_out, layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out]:
		if type(i) == tuple:
			for i_2 in i:
				new_list_of_inputs.append(i_2)
		else:
...
try:
	try:
		layer_249_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_248_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_249_out = layer_249(layer_249_concat)
	except ValueError:
		layer_249_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_248_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_249_out = layer_249(layer_249_concat)
except ValueError:
	#print('do strong concat!')
	strong_concat_249 = Strong_concat()
	new_list_of_inputs = []
	for i in [layer_0_out, layer_1_out, layer_248_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out]:
		if type(i) == tuple:
			for i_2 in i:
				new_list_of_inputs.append(i_2)
		else:
...
try:
	try:
		layer_250_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_250_out = layer_250(layer_250_concat)
	except ValueError:
		layer_250_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_250_out = layer_250(layer_250_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_251_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_251_out = layer_251(layer_251_concat)
	except ValueError:
		layer_251_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_251_out = layer_251(layer_251_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_252_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_252_out = layer_252(layer_252_concat)
	except ValueError:
		layer_252_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_252_out = layer_252(layer_252_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_253_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_253_out = layer_253(layer_253_concat)
	except ValueError:
		layer_253_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_253_out = layer_253(layer_253_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_254_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_254_out = layer_254(layer_254_concat)
	except ValueError:
		layer_254_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_254_out = layer_254(layer_254_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_255_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_255_out = layer_255(layer_255_concat)
	except ValueError:
		layer_255_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_255_out = layer_255(layer_255_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_256_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_256_out = layer_256(layer_256_concat)
	except ValueError:
		layer_256_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_256_out = layer_256(layer_256_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_257_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_257_out = layer_257(layer_257_concat)
	except ValueError:
		layer_257_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_257_out = layer_257(layer_257_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_258_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_258_out = layer_258(layer_258_concat)
	except ValueError:
		layer_258_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_258_out = layer_258(layer_258_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_259_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_259_out = layer_259(layer_259_concat)
	except ValueError:
		layer_259_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_259_out = layer_259(layer_259_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_260_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_260_out = layer_260(layer_260_concat)
	except ValueError:
		layer_260_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_260_out = layer_260(layer_260_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_261_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_261_out = layer_261(layer_261_concat)
	except ValueError:
		layer_261_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_261_out = layer_261(layer_261_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_262_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_262_out = layer_262(layer_262_concat)
	except ValueError:
		layer_262_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_262_out = layer_262(layer_262_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_263_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_263_out = layer_263(layer_263_concat)
	except ValueError:
		layer_263_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_263_out = layer_263(layer_263_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_264_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_264_out = layer_264(layer_264_concat)
	except ValueError:
		layer_264_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_264_out = layer_264(layer_264_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_265_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_265_out = layer_265(layer_265_concat)
	except ValueError:
		layer_265_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_265_out = layer_265(layer_265_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_266_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_266_out = layer_266(layer_266_concat)
	except ValueError:
		layer_266_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_266_out = layer_266(layer_266_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_267_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_267_out = layer_267(layer_267_concat)
	except ValueError:
		layer_267_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_267_out = layer_267(layer_267_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_268_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_268_out = layer_268(layer_268_concat)
	except ValueError:
		layer_268_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_268_out = layer_268(layer_268_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_269_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_269_out = layer_269(layer_269_concat)
	except ValueError:
		layer_269_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_269_out = layer_269(layer_269_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_270_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_270_out = layer_270(layer_270_concat)
	except ValueError:
		layer_270_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_270_out = layer_270(layer_270_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_271_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_271_out = layer_271(layer_271_concat)
	except ValueError:
		layer_271_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_271_out = layer_271(layer_271_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_272_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_272_out = layer_272(layer_272_concat)
	except ValueError:
		layer_272_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_272_out = layer_272(layer_272_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_273_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_273_out = layer_273(layer_273_concat)
	except ValueError:
		layer_273_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_273_out = layer_273(layer_273_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_274_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_274_out = layer_274(layer_274_concat)
	except ValueError:
		layer_274_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_274_out = layer_274(layer_274_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_275_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_275_out = layer_275(layer_275_concat)
	except ValueError:
		layer_275_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_275_out = layer_275(layer_275_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_276_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_276_out = layer_276(layer_276_concat)
	except ValueError:
		layer_276_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_276_out = layer_276(layer_276_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_277_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_277_out = layer_277(layer_277_concat)
	except ValueError:
		layer_277_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_277_out = layer_277(layer_277_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_278_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_278_out = layer_278(layer_278_concat)
	except ValueError:
		layer_278_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_278_out = layer_278(layer_278_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_279_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_279_out = layer_279(layer_279_concat)
	except ValueError:
		layer_279_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_279_out = layer_279(layer_279_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_280_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_280_out = layer_280(layer_280_concat)
	except ValueError:
		layer_280_concat = tf.keras.layers.concatenate([layer_1_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_280_out = layer_280(layer_280_concat)
except ValueError:
	#print('do strong concat!')
...
try:
	try:
		layer_247_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_247_out = layer_247(layer_247_concat)
	except ValueError:
		layer_247_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_247_out = layer_247(layer_247_concat)
except ValueError:
	#print('do strong concat!')
	strong_concat_247 = Strong_concat()
	new_list_of_inputs = []
	for i in [layer_0_out, layer_1_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out]:
		if type(i) == tuple:
			for i_2 in i:
				new_list_of_inputs.append(i_2)
		else:
...
try:
	try:
		layer_5_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_247_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_5_out = layer_5(layer_5_concat)
	except ValueError:
		layer_5_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_247_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_5_out = layer_5(layer_5_concat)
except ValueError:
	#print('do strong concat!')
	strong_concat_5 = Strong_concat()
	new_list_of_inputs = []
	for i in [layer_0_out, layer_1_out, layer_247_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out]:
		if type(i) == tuple:
			for i_2 in i:
				new_list_of_inputs.append(i_2)
		else:
...
try:
	try:
		layer_246_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_5_out, layer_247_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_246_out = layer_246(layer_246_concat)
	except ValueError:
		layer_246_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_5_out, layer_247_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_246_out = layer_246(layer_246_concat)
except ValueError:
	#print('do strong concat!')
	strong_concat_246 = Strong_concat()
	new_list_of_inputs = []
	for i in [layer_0_out, layer_1_out, layer_5_out, layer_247_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out]:
		if type(i) == tuple:
			for i_2 in i:
				new_list_of_inputs.append(i_2)
		else:
...
try:
	try:
		layer_4_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_5_out, layer_247_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out])
		layer_4_out = layer_4(layer_4_concat)
	except ValueError:
		layer_4_concat = tf.keras.layers.concatenate([layer_0_out, layer_1_out, layer_5_out, layer_247_out, layer_248_out, layer_249_out, layer_281_out, layer_282_out, layer_283_out, layer_284_out, layer_285_out], axis=-2)
		layer_4_out = layer_4(layer_4_concat)
except ValueError:
	#print('do strong concat!')
...
layer_2_out = tf.keras.layers.Flatten()(layer_2_out)
layer_2_out = tf.keras.layers.Dense(10, activation='sigmoid')(layer_2_out)
