generation_file = "default_gen_284.json"
neural_network_pop_number = 0
#Compiler
import time
...
with open('{url}/boost_perfomnc_gen/{generation_file}'.format(url=dir_path, generation_file=generation_file), 'r') as file:
	list_i = json.load(file)
	neural_netwrok_genome = list_i[neural_network_pop_number][3] # list_i is a 2-d tensor. 
